...
#define PDM_PCM_GAIN_LEFT              (CY_PDM_PCM_BYPASS)
#define PDM_PCM_GAIN_RIGHT             (CY_PDM_PCM_GAIN_10_5_DB)
#define PDM_PCM_CHANNELS               (CY_PDM_PCM_OUT_CHAN_RIGHT)
#define PDM_PCM_WORD_LEN               (CY_PDM_PCM_WLEN_16_BIT)
#define PDM_PCM_RX_FIFO_TRG_LVL        (64U)
...
extern  cy_stc_pdm_pcm_config_t PDM_PCM_config;
