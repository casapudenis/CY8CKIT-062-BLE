// ======================================================================
// CE216795_DualCoreBlinky01.v generated from TopDesign.cysch
// 06/26/2023 at 13:11
...
module top ;
	...
	wire [0:0] tmpFB_0__Pin_CM4_RedLED_net;
	wire [0:0] tmpIO_0__Pin_CM4_RedLED_net;
	electrical [0:0] tmpSIOVREF__Pin_CM4_RedLED_net;
	...
	cy_mxs40_gpio_v1_0
		...
		Pin_CM4_RedLED
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_CM4_RedLED_net[0:0]}),
		  .io({tmpIO_0__Pin_CM4_RedLED_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_CM4_RedLED_net),
		  .annotation({Net_1}));


    cy_annotation_universal_v1_0 R9 (
        .connect({
            Net_17,
            Net_1
        })
    );
    defparam R9.comp_name = "Resistor_v1_0";
    defparam R9.port_names = "T1, T2";
    defparam R9.width = 2;
	...
	wire [0:0] tmpFB_0__Pin_CM0p_BlueLED_net;
	wire [0:0] tmpIO_0__Pin_CM0p_BlueLED_net;
	electrical [0:0] tmpSIOVREF__Pin_CM0p_BlueLED_net;
	...
	cy_mxs40_gpio_v1_0
		...
		Pin_CM0p_BlueLED
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_CM0p_BlueLED_net[0:0]}),
		  .io({tmpIO_0__Pin_CM0p_BlueLED_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_CM0p_BlueLED_net),
		  .annotation({Net_13}));
