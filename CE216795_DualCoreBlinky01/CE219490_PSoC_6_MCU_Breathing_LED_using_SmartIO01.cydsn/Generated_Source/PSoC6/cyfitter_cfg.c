...
static void ClockInit(void)
{
	...
	Cy_SysClk_ClkPeriSetDivider(3u);
	...
	Cy_SysClk_PeriphAssignDivider(PCLK_SMARTIO9_CLOCK, CY_SYSCLK_DIV_16_BIT, 1u);
	Cy_SysClk_PeriphSetDivider(CY_SYSCLK_DIV_16_BIT, 1u, 20201u);
	...
	Cy_SysClk_PeriphSetDivider(CY_SYSCLK_DIV_16_BIT, 0u, 1999u);
